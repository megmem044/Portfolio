...
if submitted:
    try:
        run_id, result = execute_evaluation_run(EvaluationInput(question, paper, answer), DATABASE_PATH)
...
st.divider()
st.page_link("pages/1_Human_Review.py", label="Human review queue")
st.page_link("pages/2_Benchmark.py", label="Benchmark results")
